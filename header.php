...
<header class="header">
    <div class="row">
        <nav class="top-bar" data-topbar>
            <ul class="title-area">
                <li class="name">
                <!-- <h1 class="logo"><a href="<?php bloginfo('url')?>"> <img src="<?php echo $global_theme_options['opt-logo']['url']; ?>" alt="logo"/></a></h1> --> <a href="<?php bloginfo('url')?>"><img class="logotxt" src="/LoLWaves/wordpress/wp-content/themes/miomio/img/logo.png"> </a>
                </li>
